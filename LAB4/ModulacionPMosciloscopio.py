...
# Copyright: UIS
# Description: ModulacionPM_estudianteUIS_comuI
...
class ModulacionPMosciloscopio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionPMosciloscopio")
        ...
        self._Ac_range = Range(0, 4, 0.000001, 0.1, 200)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia de trasmisor", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=ModulacionPMosciloscopio, options=None):
