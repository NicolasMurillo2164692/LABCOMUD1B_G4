...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._ofset_range = Range(-5, 5, 0.1, 0, 200)
        self._ofset_win = RangeWidget(self._ofset_range, self.set_ofset, "'ofset'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._ofset_win)
        self._A_range = Range(0, 5, 0.1, 0, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, ofset-A, 0)
    ...
    def set_ofset(self, ofset):
        self.ofset = ofset
        self.analog_sig_source_x_1.set_offset(self.ofset-self.A)
