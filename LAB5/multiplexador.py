...
class multiplexador(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Multiplexador", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Multiplexador")
        ...
        self.settings = Qt.QSettings("GNU Radio", "multiplexador")
        ...
        self._d3_range = Range(0, 50, 1, 50, 200)
        ...
        self._d2_range = Range(0, 50, 1, 50, 200)
        ...
        self._d1_range = Range(0, 50, 1, 50, 200)
        ...
        self.connect((self.ModuladorPAM_0_0, 0), (self.blocks_delay_1, 0))
        self.connect((self.ModuladorPAM_0_1, 0), (self.blocks_delay_0, 0))
        self.connect((self.ModuladorPAM_1, 0), (self.blocks_delay_2, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModuladorPAM_0, 0))
        self.connect((self.analog_sig_source_x_1, 0), (self.ModuladorPAM_0_0, 0))
        self.connect((self.analog_sig_source_x_2, 0), (self.ModuladorPAM_0_1, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.ModuladorPAM_1, 0))
...
def main(top_block_cls=multiplexador, options=None):
