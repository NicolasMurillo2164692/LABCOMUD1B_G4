...
class diezmar(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "diezmareinterpolar")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("diezmareinterpolar")
        ...
        self.settings = Qt.QSettings("GNU Radio", "diezmar")
...
def main(top_block_cls=diezmar, options=None):
